...
///___________o__________________________________ L E T ' S  B E G I N ____________________________________________________________
...
int main()
{
	...
	int a = v[1].size(),b=v[2].size() ,c = v[3].size();
	int k = min(a , b);
	k = min(k,c);
	if (k==0)
	{
